...
TASK_3(BDD, bdd_ite, BDD, a, BDD, b, BDD, c)
TASK_2(BDD, bdd_and, BDD, a, BDD, b)
TASK_2(BDD, bdd_xor, BDD, a, BDD, b)
TASK_2(char, bdd_disjoint, BDD, a, BDD, b)
TASK_2(BDD, bdd_exists, BDD, dd, BDD, vars)
TASK_2(BDD, bdd_project, BDD, dd, BDD, vars);
TASK_3(BDD, bdd_and_exists, BDD, a, BDD, b, BDDSET, vars)
TASK_3(BDD, bdd_and_project, BDD, a, BDD, b, BDDSET, vars);
TASK_3(BDD, bdd_relprev, BDD, a, BDD, b, BDDSET, vars)
TASK_3(BDD, bdd_relnext, BDD, a, BDD, b, BDDSET, vars)
TASK_1(BDD, bdd_closure, BDD, a)
TASK_2(BDD, bdd_constrain, BDD, f, BDD, c)
TASK_2(BDD, bdd_restrict, BDD, f, BDD, c)
TASK_2(BDD, bdd_compose, BDD, f, BDDMAP, m)
TASK_2(double, bdd_satcount, BDD, dd, BDDSET, vars)
VOID_TASK_4(bdd_enum, BDD, dd, BDDSET, vars, bdd_enum_cb, cb, void*, context)
VOID_TASK_4(bdd_enum_par, BDD, dd, BDDSET, vars, bdd_enum_cb, cb, void*, context)
TASK_4(BDD, bdd_collect, BDD, dd, BDDSET, vars, bdd_collect_cb, cb, void*, context)
TASK_1(double, bdd_pathcount, BDD, dd)
TASK_3(BDD, bdd_union_cube, BDD, dd, BDDSET, vars, uint8_t*, cube)
