...
VOID_TASK_4(lddmc_visit_par, MDD, dd, lddmc_visit_callbacks*, cbs, size_t, ctx_size, void*, context);

VOID_TASK_4(lddmc_visit_seq, MDD, dd, lddmc_visit_callbacks*, cbs, size_t, ctx_size, void*, context);
