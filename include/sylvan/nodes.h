...
TASK(void, nodes_clear, nodes_table*, dbs)
TASK(void, nodes_clear_data, nodes_table*, dbs)
TASK(void, nodes_clear_hashes, nodes_table*, dbs)
TASK(int, nodes_rehash, nodes_table*, dbs)
TASK(size_t, nodes_count_marked, nodes_table*, dbs)
TASK(void, nodes_destroy_unmarked, nodes_table*, dbs)
