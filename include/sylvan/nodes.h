...
TASK(void, nodes_mark_rec, const nodes_table*, dbs, uint64_t, index)
TASK(int, nodes_rebuild, nodes_table*, dbs)
TASK(size_t, nodes_count_nodes, nodes_table*, dbs)
TASK(void, nodes_cleanup_custom, nodes_table*, dbs)
