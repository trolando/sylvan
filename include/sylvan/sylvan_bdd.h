 ...
 */
static inline BDD sylvan_nithvar(uint32_t var)
{
 ...
 */
static inline BDD sylvan_project(BDD dd, BDDSET vars);
 ...
 */
static inline BDD sylvan_and_project(BDD a, BDD b, BDDSET vars);
...
static inline BDD sylvan_union_cube(BDD dd, BDDSET variables, uint8_t* cube);
...
typedef void (*enum_cb)(void*, BDDVAR*, uint8_t*, int);

static inline void sylvan_enum(BDD dd, BDDSET vars, enum_cb cb, void* context);

static inline void sylvan_enum_par(BDD dd, BDDSET vars, enum_cb cb, void* context);
...
typedef BDD (*sylvan_collect_cb)(void*, uint8_t*);

static inline BDD sylvan_collect(BDD dd, BDDSET vars, sylvan_collect_cb cb, void* context);
...
TASK(BDD, sylvan_ite, BDD, a, BDD, b, BDD, c)
TASK(BDD, sylvan_and, BDD, a, BDD, b)
TASK(BDD, sylvan_xor, BDD, a, BDD, b)
TASK(char, sylvan_disjoint, BDD, a, BDD, b)
TASK(BDD, sylvan_exists, BDD, dd, BDD, vars)
TASK(BDD, sylvan_project, BDD, dd, BDD, vars);
TASK(BDD, sylvan_and_exists, BDD, a, BDD, b, BDDSET, vars)
TASK(BDD, sylvan_and_project, BDD, a, BDD, b, BDDSET, vars);
TASK(BDD, sylvan_relprev, BDD, a, BDD, b, BDDSET, vars)
TASK(BDD, sylvan_relnext, BDD, a, BDD, b, BDDSET, vars)
TASK(BDD, sylvan_closure, BDD, a)
TASK(BDD, sylvan_constrain, BDD, f, BDD, c)
TASK(BDD, sylvan_restrict, BDD, f, BDD, c)
TASK(BDD, sylvan_compose, BDD, f, BDDMAP, m)
TASK(double, sylvan_satcount, BDD, dd, BDDSET, vars)
...
TASK(double, sylvan_pathcount, BDD, dd)
