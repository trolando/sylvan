 ...
 */
TASK(ZDD, zdd_from_mtbdd, MTBDD, dd, MTBDD, domain);

/**
 * Convert a ZDD to an MTBDD.
 */
TASK(MTBDD, zdd_to_mtbdd, ZDD, dd, ZDD, domain);
 ...
 */
TASK(ZDD, zdd_union_cube, ZDD, set, ZDD, variables, uint8_t*, values, ZDD, leaf);
 ...
 */
TASK(MTBDD, zdd_cover_to_bdd, ZDD, dd);
 ...
 */
TASK(double, zdd_pathcount, ZDD, dd);
 ...
 */
TASK(ZDD, zdd_ite, ZDD, f, ZDD, g, ZDD, h, ZDD, dom);

/**
 * Compute the negation of a ZDD w.r.t. the given domain.
 */
TASK(ZDD, zdd_not, ZDD, dd, ZDD, dom);
 ...
 */
TASK(void, zdd_visit_seq, ZDD, dd, zdd_visit_pre_cb, precb, zdd_visit_post_cb, postcb, void*, context);

/**
 * Parallel visit operation
 */
TASK(void, zdd_visit_par, ZDD, dd, zdd_visit_pre_cb, precb, zdd_visit_post_cb, postcb, void*, context);
 ...
 */
TASK(void, zdd_writer_tobinary, FILE *, file, ZDD *, dds, int, count);
...
TASK(void, zdd_writer_totext, FILE *, file, ZDD *, dds, int, count);
 ...
 */
TASK(int, zdd_reader_frombinary, FILE*, file, ZDD*, dds, int, count);
 ...
 */
TASK(void, zdd_gc_mark_rec, ZDD, dd);
