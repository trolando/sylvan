...
VOID_TASK_5(bdd_enum_par_do, BDD, bdd, BDDSET, vars, bdd_enum_cb, cb, void*, context, struct bdd_path*, path)
...
TASK_5(BDD, bdd_collect_do, BDD, bdd, BDDSET, vars, bdd_collect_cb, cb, void*, context, struct bdd_path*, path)
