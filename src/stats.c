...
} sylvan_report_info[] =
{
    ...
    {2, BDD_SAT_COUNT_U64, "BDD sat count u64"},
    {2, BDD_SAT_COUNT_DOUBLE, "BDD sat count double"},
    {2, BDD_SAT_COUNT_GMP, "BDD sat count GMP"},
    ...
    {2, MTBDD_ALL_LEQ, "MTBDD all leq"},
    {2, MTBDD_ALL_LT, "MTBDD all lt"},
    {2, MTBDD_ALL_GEQ, "MTBDD all geq"},
    {2, MTBDD_ALL_GT, "MTBDD all gt"},
    {2, MTBDD_AND_ABSTRACT_PLUS, "MTBDD and_abs_plus"},
    {2, MTBDD_AND_ABSTRACT_MAX, "MTBDD and_abs_max"},
    {2, MTBDD_COMPOSE, "MTBDD compose"},
    {2, MTBDD_EVAL, "MTBDD eval"},
    {2, MTBDD_MINIMUM, "MTBDD minimum"},
    {2, MTBDD_MAXIMUM, "MTBDD maximum"},
    {2, MTBDD_EVAL_COMPOSE, "MTBDD eval_compose"},
    {2, MTBDD_ANY_LEQ, "MTBDD any leq"},
    {2, MTBDD_ANY_LT, "MTBDD any lt"},
    {2, MTBDD_ANY_GEQ, "MTBDD any geq"},
    {2, MTBDD_ANY_GT, "MTBDD any gt"},
    {2, MTBDD_ANY_EQUAL_ABS, "MTBDD any equal abs"},
    {2, MTBDD_ANY_EQUAL_REL, "MTBDD any equal rel"},
    {2, MTBDD_COMPARE_LEQ, "MTBDD compare leq"},
    {2, MTBDD_COMPARE_LT, "MTBDD compare lt"},
    {2, MTBDD_COMPARE_GEQ, "MTBDD compare geq"},
    {2, MTBDD_COMPARE_GT, "MTBDD compare gt"},
    {2, MTBDD_COMPARE_EQUAL_ABS, "MTBDD compare equal abs"},
    {2, MTBDD_COMPARE_EQUAL_REL, "MTBDD compare equal rel"},
    {2, MTBDD_SAT_COUNT_U64, "MTBDD sat count u64"},
    {2, MTBDD_SAT_COUNT_DOUBLE, "MTBDD sat count double"},
    {2, MTBDD_SAT_COUNT_GMP, "MTBDD sat count GMP"},
    ...
    {2, LDD_SATCOUNT_GMP, "LDD satcount GMP"},
    {2, LDD_ZIP, "LDD zip"},
    ...
    {2, ZDD_FORALL, "ZDD forall" },
    {2, ZDD_UNIQUE, "ZDD unique" },
    {2, ZDD_PROJECT, "ZDD project" },
    {2, ZDD_COUNT_U64, "ZDD count_u64" },
